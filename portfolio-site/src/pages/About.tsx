          ...
          <div className="section">
            <div className="written-section">
              <p id="written">
                ...
                creative thinking, and loads of energy to the table. My journey
                in the tech and marketing realms has been fueled by an
                insatiable curiosity, a passion for learning, an unwavering
                commitment to innovation, and an eternal love for coffee.
              </p>
          ...
          <div className="grid-container">
            <section className="about-section">
              ...
              <p>
                ...
                contrasting harmony to my off-screen world. I'm a bassist,
                deeply immersed in the realms of jazz, funk, and rock. The
                strings of my bass guitar resonate with the same vibrancy that
                fuels my coding endeavors.
              </p>
            </section>
            ...
            <section className="about-section">
              ...
              <p>
                ...
                seamlessly merged technical expertise with strategic marketing
                insights. My academic journey has been complemented by
                real-world experiences, each role contributing to my growth and
            ...
            <section className="about-section">
              ...
              <p>
                ...
                thrill of the road, the strategic nuances of gaming, and the
                immersive narratives of anime fuel my sense of exploration and
                creativity.
              </p>
            </section>
            ...
            <section className="about-section">
              ...
              <p>
                ...
                of industry trends. My career aspirations revolve around the
                intersection of technology, data, and strategic marketing. I
                thrive in dynamic environments, leveraging my skills to
                contribute meaningfully to innovative projects and initiatives.
              </p>
            </section>
          </div>
